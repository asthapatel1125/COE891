...
public class EmailIdValidatorTest {
 ...
 private boolean expected;
	 ...
	 //{index} represents the current index test case
	 //isValid({0}) represents the email address or the actual value
	 //{1} represents the expected value
 ...
 public void testIsValidEmailId() throws Exception {
		 ...
		 //or: assertThat(actual, is(equalTo(expected)));
	 }
 }
